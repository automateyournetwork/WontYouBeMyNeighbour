"""
Ralph API Server Runner

Starts the Ralph REST API server.
"""
...
async def main():
    """Run Ralph API server"""
    parser = argparse.ArgumentParser(description="Ralph Network Agent API Server")
    parser.add_argument("--host", default="0.0.0.0", help="Host to bind to")
    parser.add_argument("--port", type=int, default=8080, help="Port to listen on")
    parser.add_argument("--ralph-id", default="ralph-1", help="Ralph instance ID")
    ...
    print(f"Starting Ralph API Server...")
    print(f"  Ralph ID: {args.ralph_id}")
