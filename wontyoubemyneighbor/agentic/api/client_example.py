"""
ASI API Client Examples

Demonstrates how to interact with ASI via REST API.
"""
...
class ASIClient:
    """Simple client for ASI REST API"""
...
async def example_curl_commands():
    ...
    commands = [
        ...
        ('Query ASI', '''curl -X POST http://localhost:8080/api/query \\
